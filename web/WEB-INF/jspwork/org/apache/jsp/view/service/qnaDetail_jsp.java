 ...
 * Generated at: 2019-03-10 04:06:42 UTC
...
public final class qnaDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("service.qna.model.vo.QNAReply");
 ...
 if(qna.getFile1() != null){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t첨부파일 : \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"/diedie/fdown?fname=");
      out.print( qna.getFile1() );
      out.write("&frename");
      out.print( qna.getRefile1() );
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
 if(qna.getFile2() != null){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t&nbsp; | ");
      out.print( qna.getFile2() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
 } 
      out.write("\r\n");
 ...
 if(qna.getFile3() != null){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"/diedie/qlist\" class=\"button small\">목록</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 if(loginUser.getUserId().equals(qna.getUserId())){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"/diedie/qmoview?qno=");
      out.print( qna.getqNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\" class=\"button small\">수정</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a onclick=\"deleteQna();\" class=\"button small\">삭제</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfunction deleteQna(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tif(confirm('게시물을 삭제하시겠습니까?') == true){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tlocation.href = \"/diedie/qdelete?qno=");
      out.print( qno );
      out.write("\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tlocation.href = \"/diedie/qdetail?qno=");
      out.print( qno );
      out.write("\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"table wrapper\" align=\"center\" style=\"float: left;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
 if(list != null){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
 for(QNAReply qr : list){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"box\" style=\"height: 100px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print( qr.getUserId() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print( qr.getQdate() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print( qr.getContent() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
 } 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"demo-message\" id=\"demo-message\" rows=\"1\" style=\"width: 850px;\" placeholder=\"댓글을 입력하세요.\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"/diedie/qrwrite\" class=\"button primary\" style=\"margin-left: 5px; height: 44px; float: left;\">등록</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</section>\r\n");
