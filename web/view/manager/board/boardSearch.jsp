	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<h2 style="font-family: '나눔스퀘어라운드'; font-size: 20pt">게시글 관리</h2>
				</p>
				<font face="나눔스퀘어라운드" size="2pt">- 모든 게시글을 검색, 관리 할 수 있습니다</font> <br>
				<form id="category">
					<select id="class1"
						style="width: 150px; height: 40px; position: absolute; left: 53px; top: 250px;">
						<option selected>전체 게시판</option>
						<option>공지사항</option>
						<option>갤러리</option>
						<option>자유게시판</option>
						<option>정보공유게시판</option>
						<option>질문게시판</option>
					</select>
					<input type="button" value="적용" style="position:absolute; left: 210px; top: 250px;">
				</form>
